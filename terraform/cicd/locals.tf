locals {
  ...
  environment_role = {
    dev = "arn:aws:iam::804295906245:role/archit-nangla-github-actions"
  }
  ...
  artifacts_bucket    = "archit-nangla-arc-iac-training-latest"
...
#   }
  ...
  role_data = {
    ...
    "${local.prefix}-codebuild-terraform" = {
      ...
      github_secret_arn                   = null
      terraform_state_s3_bucket           = "archit-nangla-arc-iac-training-latest"
      dynamodb_lock_table                 = "archit-nangla-arc-iac-training-latest"
      additional_iam_policy_doc_json_list = []
    }
  }
